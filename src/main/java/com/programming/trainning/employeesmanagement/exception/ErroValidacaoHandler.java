...
import com.programming.trainning.employeesmanagement.cargo.EntityAlreadyExistsException;
...
public class ErroValidacaoHandler {
    ...
    public ErroAplicacao handleEntityAlreadyExists(Exception exception) {
        return new ErroAplicacao(exception.getMessage());
    }
}
